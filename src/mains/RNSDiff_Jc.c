 ...
 * momentum (J_DM). It iteratively adjusts the baryonic and dark matter
 * axis ratios and the dark matter central energy density to simultaneously
 * satisfy constraints on the global dark matter fraction and angular momenta.
 *
    ...
    for (c = getopt(argc, argv, "+hc:j:d:");
        ...
        switch (c) {
            ...
            case 'h':
                ...
                printf("\t>> ./RNS\n\n");
                printf("Run \n\t>> ./RNS -c config.d [-j Jtot_Target] [-d JDM_Target]\n");
